               ...
               //var numberOfEmailFlag = 0;
                ...
                if(!amount || !description || !emailid)
                {
                        $.bootstrapGrowl("Enter Data");
                          ...
                          $.ajax({
                                type: "POST",
                                url: "http://localhost/Project-Link/php/SplitsWiseFlowToDatabase.php",
                                data: dataString,
                                cache: false,
                                async: false,
                                success: function(result){
                                  if(result=='Email Id does not exits in the system'){
                                    console.log("getting proper response");
                                  }else{
                                    console.log('sucess rate is :'+result);
                                  }
