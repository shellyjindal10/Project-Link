		...
		<div class="inbox_main_div">
		        ...
		        <div class="resultOfMessages">
		                                        <?php
							                                        ...
							                                        $query="select * from message where MessageToMailId='$senderEmailId' $max";
					                                                $mssages_result = mysqli_query($dbConn2,$query);
					                                                $row_cnt = mysqli_num_rows($mssages_result);
					                                                if($row_cnt){
...
<?php 
			...
			<div class="searchId">
					...
					<div class="delete_icon" >
					     ...
					     <img src="../image/delete.jpg" name="delete" alt="delete_image" width='100%' height='100%' title="Delete">
					     </a> 
					</div>
					<div class="replyTo">
					    <a href="../php/deleteAndReplyMail.php?action=reply&messageid=<?php echo $message_id?>">
						<img src="../image/reply-to.png" name="Reply" alt="replyTo_image" width='100%' height='100%' title="Reply">
						</a>
					</div>
					<div class="forward">
